...
func forSelect(w http.ResponseWriter, r *http.Request) {
	var (
		req = requests.Select{
	...
	repo := select_account_repository.NewPostgreSQL(postgresql_database.New())

	res, err := select_query.New(req, repo).Find(r.Context())
	if err != nil {
