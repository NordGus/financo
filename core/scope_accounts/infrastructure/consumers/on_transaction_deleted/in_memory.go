...
import (
	"financo/core/scope_accounts/application/event_handlers/on_transaction_deleted"
...
func NewInMemory(wg *sync.WaitGroup, payload messages.Deleted) {
	...
	err := on_transaction_deleted.New(accountsRepo, transactionsRepo, repo).Handle(payload)
	if err != nil {
