...
import (
	"financo/core/scope_accounts/application/event_handlers/on_transaction_updated"
...
func NewInMemory(wg *sync.WaitGroup, payload messages.Updated) {
	...
	err := on_transaction_updated.New(accountsRepo, transactionsRepo, repo).Handle(payload)
	if err != nil {
