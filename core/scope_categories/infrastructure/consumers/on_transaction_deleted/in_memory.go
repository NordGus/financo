...
import (
	"financo/core/scope_categories/application/event_handlers/on_transaction_deleted"
...
func NewInMemory(wg *sync.WaitGroup, payload messages.Deleted) {
	...
	err := on_transaction_deleted.New(categoriesRepo, transactionsRepo, repo).Handle(payload)
	if err != nil {
