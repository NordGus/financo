package on_savings_goal_deleted

import (
	"financo/core/scope_savings_goals/application/event_handlers/on_savings_goal_deleted"
...
func NewInMemory(wg *sync.WaitGroup, payload messages.Deleted) {
	...
	err := on_savings_goal_deleted.New(goals, savings, update).Handle(payload)
	if err != nil {
