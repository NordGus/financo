...
const DEFAULT_ICON: Icon = "hand-coins"
const DEFAULT_COLOR = "#fc004f"
const DEFAULT_NAME = "New Debt"
...
const schema = z.object({
  ...
  capital: z.number({ error: "required" })
    .refine((val) => val !== 0, { error: "required" }),
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              />
              <FormDescription>
                {"The amount you owe or your are owed. A negative amount means you owe while a positive means you are owed"}
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              />
              <FormDescription>
                The balance of the debt at the starting date
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
