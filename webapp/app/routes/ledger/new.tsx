  ...
  return (
    <CurrenciesContextProvider currencies={currencies}>
      <AccountsContextProvider accounts={accounts} accountsMap={accountsMap}>
        <section className="grid grid-cols-2 grid-rows-[0.75fr_1fr_0.5fr_min-content_0.75fr_min-content] h-full max-h-full p-4 gap-2 overflow-y-auto no-scrollbar relative">
          <FullScreenThrobber
            className={cn(
