...
import { pendingTransactionsForAccountQuery } from "@queries/transactions"
...
export default function Pending({ account, className }: Props) {
    const query = useQuery(pendingTransactionsForAccountQuery(account.id))
