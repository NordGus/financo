...
import { monthsUpcomingTransactionsForAccountQuery } from "@queries/transactions"
...
export default function Upcoming({ account, className }: Props) {
    const query = useQuery(monthsUpcomingTransactionsForAccountQuery(account.id))
